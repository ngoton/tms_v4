...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 22, 2018 at 08:17 PM
...
(1, 'admin', '81dc9bdb52d04dc20036dbd8313ed055', 'ngoton007@yahoo.com', 1527218218, 1, 0, NULL, NULL, '[\"all\"]', '[\"all\"]', 1529677429),
...
--
ALTER TABLE `shipment_cost`
  MODIFY `shipment_cost_id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `user_log`
  MODIFY `user_log_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=165;
