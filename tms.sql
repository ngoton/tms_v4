...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 19, 2018 at 07:36 PM
...
(1, 1527786000, 'DH001', 2, '8624223', 2, 2, 'CMA', '4232', 1, 2, 1528650000, 1529427600, 'Hang nhập', 3, '4100000.00', 1, 1, 1, 3, NULL),
(2, 1529254800, 'DH002', 3, '0435265353', 1, 1, 'A', '642', 2, 1, 1529254800, 1530291600, 'Hàng dễ vỡ', 2, '3000000.00', 1, NULL, NULL, 1, NULL);
...
INSERT INTO `dispatch` (`dispatch_id`, `dispatch_date`, `dispatch_code`, `dispatch_shipment_temp`, `dispatch_booking`, `dispatch_booking_detail`, `dispatch_booking_detail_number`, `dispatch_place_from`, `dispatch_place_to`, `dispatch_vehicle`, `dispatch_romooc`, `dispatch_staff`, `dispatch_start_date`, `dispatch_end_date`, `dispatch_comment`, `dispatch_create_user`, `dispatch_update_user`, `dispatch_status`) VALUES
(1, 1529341200, 'DX01', 2, 1, NULL, NULL, 1, 2, 2, 1, 1, 1529254800, 1529427600, 'Hàng xuất', 1, 1, NULL);
...
CREATE TABLE `shipment` (
  ...
  `shipment_do` int(11) DEFAULT NULL,
  ...
  `shipment_revenue` decimal(14,2) DEFAULT NULL,
...
(1, 'admin', '81dc9bdb52d04dc20036dbd8313ed055', 'ngoton007@yahoo.com', 1527218218, 1, 0, NULL, NULL, '[\"all\"]', '[\"all\"]', 1529416442),
