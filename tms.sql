...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 27, 2018 at 11:03 AM
...
(1, 1529341200, 'DX01', 2, 2, 2, 1, NULL, NULL, 1, 2, 2, 1, 1, 1529254800, 1529427600, 0, 3, 2, 3, 'Hàng xuất', 1, 1, 1, 4, 3, 3, 1, 2, NULL, NULL, 2, 1, 1529254800, 1530291600, 3, 3, 40, 2, 'Lô phụ'),
...
(9, 1529946000, 'DX04', 3, 3, 1, 2, NULL, NULL, 2, 1, 2, 1, 1, 1529254800, 1530291600, 0, 0, 1, 4, '', 1, 1, NULL, NULL, 0, 0, 0, 0, NULL, NULL, 0, 0, 0, 0, 0, 0, 0, 6, '');
...
(1, 1529341200, 1, 2, 2, '423', 2, 1, 1, 1, 3, 'CU0232355', 2, 2, 4, 1, 2, 1529255160, 1529427960, 0, 5, 'Hàng xuất', 1, 1, NULL, NULL, '0.00', '0.00', 0, '1,2', NULL),
(3, 1529341200, 1, 3, 1, 'A2243', 2, 1, 1, 2, 6, 'LU4354522', 1, 1, 4, 2, 1, 1529255160, 1530291960, NULL, NULL, 'Lô phụ', 1, NULL, NULL, NULL, '2000000.00', NULL, 1, '4', NULL),
(5, 1529686800, 1, 3, 1, 'P042423', 2, 1, 1, 2, 5, 'PI23243532', 1, 1, 5, 2, 1, 1529255160, 1530291960, 4, 0, 'Lô phụ', 1, 1, NULL, NULL, '0.00', '0.00', 1, '4', NULL),
(7, 1529341200, 1, 2, 2, '', 2, 1, 1, 1, 4, 'AU64542', 1, 1, 3, 1, 2, 1529255160, 1529427960, 0, 3, 'Hàng xuất', 1, NULL, NULL, NULL, '100000.00', '1690000.00', 0, '1,2', '{"shipment_cost_lift_on":"0","shipment_cost_lift_off":"0","shipment_cost_lift_on_null":"0","shipment_cost_lift_off_null":"350000","shipment_cost_deposit":"0","shipment_cost_clean":"0","shipment_cost_trans":"0","shipment_cost_weight":"0","shipment_cost_document":"0","shipment_cost_toll":"60000","shipment_cost_cont":"480000","shipment_cost_ton":"150000","shipment_cost_police":"300000","shipment_cost_tire":"350000"}');
...
(1, 'admin', '81dc9bdb52d04dc20036dbd8313ed055', 'ngoton007@yahoo.com', 1527218218, 1, 0, NULL, NULL, '["all"]', '["all"]', 1530060990),
...
--
-- Indexes for table `shipment_cost`
--
...
--
ALTER TABLE `booking_detail`
MODIFY `booking_detail_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=8;
--
...
--
ALTER TABLE `dispatch`
MODIFY `dispatch_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=10;
--
...
--
-- AUTO_INCREMENT for table `shipdeposit`
--
ALTER TABLE `shipdeposit`
...
--
-- AUTO_INCREMENT for table `shipment_cost`
--
ALTER TABLE `shipment_cost`
...
--
ALTER TABLE `user_log`
MODIFY `user_log_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=216;
--
