...
(10, 1571763600, NULL, 6, '', 3, 0, '', '', NULL, NULL, NULL, NULL, 'Đóng cont', NULL, NULL, 1, NULL, 1, 0, NULL),
(11, 1571590800, NULL, 7, '', 3, 0, '', '', NULL, NULL, NULL, NULL, 'NM NT', NULL, NULL, 1, NULL, NULL, NULL, NULL),
(12, 1571331600, NULL, 8, '', 3, 0, '', '', NULL, NULL, NULL, NULL, '8.21T', NULL, NULL, 1, NULL, NULL, NULL, NULL),
(13, 1624467600, NULL, 6, 'BK06202103', 2, 1, 'NP2', '001', 1, 2, 1624467600, 1624467600, 'BK06', 0, 0.00, 1, 1, 2, 0, NULL),
(14, 1635181200, NULL, 8, 'VH25-2HPG1125S', 1, 6, 'VIETSUN HARMONY 1125S', 'CAIIU6869966', NULL, NULL, NULL, NULL, '', NULL, NULL, 1, NULL, 1, 0, NULL),
(16, 1635181200, NULL, 9, 'TH16-3HPG2131S', 1, 6, 'TRUONGHAI STAR 3 - 2131S', 'DRYU3093890', NULL, NULL, NULL, NULL, '', NULL, NULL, 1, NULL, 1, 0, NULL),
(17, 1646154000, NULL, 6, '1234', 2, 0, 'bnm', 'nb', NULL, NULL, NULL, NULL, 'nk', NULL, NULL, 1, NULL, NULL, NULL, NULL);
...
(8, 5, '', '', 5, 4, '', 0.00),
(9, 6, '', '', 5, 5, '', 0.00),
(10, 13, 'BLU99323', 'X932', NULL, NULL, NULL, NULL);
...
--
-- Table structure for table `checking_cost`
--

CREATE TABLE IF NOT EXISTS `checking_cost` (
  `checking_cost_id` int(11) NOT NULL AUTO_INCREMENT,
...
(2, 1624381200, 1, 1, 'DX02', 5, 0, 'BK06202103', 2, 10, 6, 4, 'Hàng nặng', NULL),
(3, 1624381200, 1, 1, 'DX02', 6, 0, 'BK352724', 1, 30, 2, 2, 'Bột mì', NULL),
(4, 1646067600, 1, NULL, 'DX03', 5, 0, 'sdsa', 1, 4, 6, 4, '44', NULL),
(5, 1646154000, 1, NULL, 'DX04', 5, 0, 'bhb', 1, 4, 6, 4, 'hg', NULL),
(6, 1646154000, 1, NULL, 'DX04', 5, 0, 'bhb', 1, 4, 6, 4, 'hg', NULL);
...
CREATE TABLE IF NOT EXISTS `cost_list` (
  `cost_list_id` int(11) NOT NULL AUTO_INCREMENT,
...
(6, 'OK', 'Ông Kỳ', 'PACIFIC LINES BUILDING', '', '', 1, '', '', '', 0, '', '', '6', 1),
(7, 'TN', 'Thanh Nhã', 'Thanh Nhã', '', '', 1, '', '', '', 0, '', '', '6', 1),
(8, 'TGH', 'Thái Gia Hưng', 'Linfox', '', '', 1, '', '', '', 0, '', '', '7', 1),
(9, 'VTTC', 'VTTC', 'CÔNG TY CỔ PHẦN DU LỊCH VÀ THƯƠNG MẠI - VINACOMIN', '0 1 0 0 1 0 1 2 9 8', 'Tầng 8, Tòa nhà Việt Á, phố Duy Tân, Phường Dịch Vọng Hậu, Quận Cầu Giấy, Thành phố Hà Nội, Việt Nam', 24, '', '', '', 2147483647, 'Vietcombank', 'Sở Giao Dịch', '8', 1);
...
(11, 1624381200, 'DX06', 5, 6, 2, 13, NULL, NULL, 1, 2, 5, 0, 0, 1624467600, 1624467600, 0, 0, 1, 6, 'Hàng xuất', 1, NULL, 1, 1, 0, 0, 0, 0, NULL, NULL, 0, 0, 0, 0, 0, 0, 0, 6, '');
...
--
-- Table structure for table `export_stock`
--
...
--
-- Dumping data for table `export_stock`
--
...
--
-- Table structure for table `import_stock`
--
...
--
-- Dumping data for table `import_stock`
--
...
--
-- Table structure for table `import_stock_cost`
--

CREATE TABLE IF NOT EXISTS `import_stock_cost` (
  `import_stock_cost_id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`import_stock_cost_id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;

--
-- Dumping data for table `import_stock_cost`
--
...
--
-- Table structure for table `insurance_cost`
--

CREATE TABLE IF NOT EXISTS `insurance_cost` (
  `insurance_cost_id` int(11) NOT NULL AUTO_INCREMENT,
...
(1, 'PQ', 'Phú Quốc', 33, 10.289879, 103.984020, NULL),
(2, 'BL', 'Bến Lức', 39, 10.641162, 106.485601, NULL),
...
--
-- Table structure for table `repair_code`
--

CREATE TABLE IF NOT EXISTS `repair_code` (
  `repair_code_id` int(11) NOT NULL AUTO_INCREMENT,
  `repair_code_name` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`repair_code_id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;

--
-- Dumping data for table `repair_code`
--
...
CREATE TABLE IF NOT EXISTS `repair_list` (
  `repair_list_id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `road_cost` (
  `road_cost_id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `road_toll` (
  `road_toll_id` int(11) NOT NULL AUTO_INCREMENT,
  `road` int(11) DEFAULT NULL,
  `toll` int(11) DEFAULT NULL,
  `road_toll_money` decimal(10,0) DEFAULT NULL,
  `road_toll_vat` int(11) DEFAULT NULL,
  PRIMARY KEY (`road_toll_id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `shipdeposit`
--

CREATE TABLE IF NOT EXISTS `shipdeposit` (
  `shipdeposit_id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`shipdeposit_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;

--
-- Dumping data for table `shipdeposit`
--
...
(11, 1624381200, 11, 6, 2, 'DO002323', 5, 0, 0, 13, 10, 'BLU99323', 1, 1, 6, 1, 2, 1624467960, 1624467960, 0, 0, 'Hàng xuất', 1, NULL, NULL, NULL, 0.00, 1340000.00, 0, '1,2', '{\"shipment_cost_lift_on\":\"0\",\"shipment_cost_lift_off\":\"0\",\"shipment_cost_lift_on_null\":\"0\",\"shipment_cost_lift_off_null\":\"0\",\"shipment_cost_deposit\":\"0\",\"shipment_cost_clean\":\"0\",\"shipment_cost_trans\":\"0\",\"shipment_cost_weight\":\"0\",\"shipment_cost_document\":\"0\",\"shipment_cost_toll\":\"60000\",\"shipment_cost_cont\":\"480000\",\"shipment_cost_ton\":\"150000\",\"shipment_cost_police\":\"300000\",\"shipment_cost_tire\":\"350000\",\"shipment_cost_release\":\"0\",\"shipment_cost_park\":\"0\"}');
...
CREATE TABLE IF NOT EXISTS `shipment_cost` (
  `shipment_cost_id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `shipment_temp` (
  `shipment_temp_id` int(11) NOT NULL AUTO_INCREMENT,
...
(5, 1624381200, 1, 13, 1, 0, NULL, 10),
(6, 1635267600, 1, 14, 0, 0, NULL, 1),
(7, 1635267600, 1, 16, 0, 0, NULL, 1),
(8, 0, 1, 10, 0, 0, NULL, 0);
...
--
-- Table structure for table `spare_drap`
--
...
--
-- Table structure for table `spare_part_code`
--

CREATE TABLE IF NOT EXISTS `spare_part_code` (
  `spare_part_code_id` int(11) NOT NULL AUTO_INCREMENT,
  `code` varchar(50) DEFAULT NULL,
  `name` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`spare_part_code_id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;

--
-- Dumping data for table `spare_part_code`
--
...
--
-- Table structure for table `spare_stock`
--
...
--
-- Dumping data for table `spare_stock`
--
...
--
-- Table structure for table `spare_vehicle`
--
...
(1, 'admin', '81dc9bdb52d04dc20036dbd8313ed055', 'ngoton007@yahoo.com', 1527218218, 1, 0, NULL, NULL, '[\"all\"]', '[\"all\"]', 1646270371),
...
(313, 1, 1571380874, 'vehicle', 'Xóa', '\"1\"', 'Xe'),
(314, 1, 1571380883, 'vehicle', 'Xóa', '\"2\"', 'Xe'),
(315, 1, 1571381055, 'vehicle', 'Thêm mới', '{\"vehicle_brand\":\"17\",\"vehicle_model\":\"FL8JTSL6X\",\"vehicle_year\":\"\",\"vehicle_country\":\"220\",\"vehicle_owner\":null,\"vehicle_number\":\"51D-27360\",\"vehicle_oil\":\"\",\"vehicle_volume\":\"7684\"}', 'Xe'),
(316, 1, 1571381105, 'place', 'Cập nhật', '{\"place_province\":\"39\",\"place_name\":\"B\\u1ebfn L\\u1ee9c\",\"place_code\":\"BL\",\"place_lat\":\"10.641162\",\"place_long\":\"106.4856006\",\"place_port\":null}', 'Kho hàng'),
(317, 1, 1571381133, 'place', 'Cập nhật', '{\"place_province\":\"33\",\"place_name\":\"Ph\\u00fa Qu\\u1ed1c\",\"place_code\":\"PQ\",\"place_lat\":\"10.289879\",\"place_long\":\"103.98401999999999\",\"place_port\":null}', 'Kho hàng'),
(318, 1, 1571381162, 'shipping', 'Cập nhật', '{\"shipping_country\":\"220\",\"shipping_name\":\"NP1\"}', 'Hãng tàu'),
(319, 1, 1571381175, 'shipping', 'Cập nhật', '{\"shipping_country\":\"220\",\"shipping_name\":\"NP2\"}', 'Hãng tàu'),
(320, 1, 1571381185, 'shipping', 'Cập nhật', '{\"shipping_country\":\"220\",\"shipping_name\":\"NP3\"}', 'Hãng tàu'),
(321, 1, 1571381192, 'shipping', 'Thêm mới', '{\"shipping_country\":\"1\",\"shipping_name\":\"NP5\"}', 'Hãng tàu'),
(322, 1, 1571381209, 'shipping', 'Thêm mới', '{\"shipping_country\":\"220\",\"shipping_name\":\"NP6\"}', 'Hãng tàu'),
(323, 1, 1571381256, 'vehicle', 'Thêm mới', '{\"vehicle_brand\":\"17\",\"vehicle_model\":\"\",\"vehicle_year\":\"\",\"vehicle_country\":\"220\",\"vehicle_owner\":null,\"vehicle_number\":\"51D-14199\",\"vehicle_oil\":\"\",\"vehicle_volume\":\"\"}', 'Xe'),
(324, 1, 1571381274, 'vehicle', 'Thêm mới', '{\"vehicle_brand\":\"17\",\"vehicle_model\":\"\",\"vehicle_year\":\"\",\"vehicle_country\":\"220\",\"vehicle_owner\":null,\"vehicle_number\":\"51C-86365\",\"vehicle_oil\":\"\",\"vehicle_volume\":\"\"}', 'Xe'),
(325, 1, 1571381292, 'vehicle', 'Thêm mới', '{\"vehicle_brand\":\"17\",\"vehicle_model\":\"\",\"vehicle_year\":\"\",\"vehicle_country\":\"220\",\"vehicle_owner\":null,\"vehicle_number\":\"51C-87101\",\"vehicle_oil\":\"\",\"vehicle_volume\":\"\"}', 'Xe'),
(326, 1, 1571381312, 'vehicle', 'Thêm mới', '{\"vehicle_brand\":\"17\",\"vehicle_model\":\"\",\"vehicle_year\":\"\",\"vehicle_country\":\"220\",\"vehicle_owner\":null,\"vehicle_number\":\"51D-47050\",\"vehicle_oil\":\"\",\"vehicle_volume\":\"\"}', 'Xe'),
(327, 1, 1571381332, 'vehicle', 'Thêm mới', '{\"vehicle_brand\":\"17\",\"vehicle_model\":\"\",\"vehicle_year\":\"\",\"vehicle_country\":\"220\",\"vehicle_owner\":null,\"vehicle_number\":\"51D-80131\",\"vehicle_oil\":\"\",\"vehicle_volume\":\"\"}', 'Xe'),
(328, 1, 1571381352, 'vehicle', 'Thêm mới', '{\"vehicle_brand\":\"17\",\"vehicle_model\":\"\",\"vehicle_year\":\"\",\"vehicle_country\":\"220\",\"vehicle_owner\":\"1\",\"vehicle_number\":\"68C-04433\",\"vehicle_oil\":\"\",\"vehicle_volume\":\"\"}', 'Xe'),
(329, 1, 1571381370, 'vehicle', 'Thêm mới', '{\"vehicle_brand\":\"17\",\"vehicle_model\":\"\",\"vehicle_year\":\"\",\"vehicle_country\":\"220\",\"vehicle_owner\":\"1\",\"vehicle_number\":\"68C-03744\",\"vehicle_oil\":\"\",\"vehicle_volume\":\"\"}', 'Xe'),
(330, 1, 1571381432, 'customer', 'Xóa', '\"2\"', 'Khách hàng - đối tác'),
(331, 1, 1571381447, 'customer', 'Xóa', '[\"3\",\"1\",\"4\",\"5\"]', 'Khách hàng - đối tác'),
(332, 1, 1571381491, 'customer', 'Thêm mới', '{\"customer_code\":\"OK\",\"customer_name\":\"\\u00d4ng K\\u1ef3\",\"customer_company\":\"PACIFIC LINES BUILDING\",\"customer_mst\":\"\",\"customer_address\":\"\",\"customer_province\":\"1\",\"customer_phone\":\"\",\"customer_mobile\":\"\",\"customer_email\":\"\",\"customer_bank_account\":\"\",\"customer_bank_name\":\"\",\"customer_bank_branch\":\"\",\"customer_type\":\"1\",\"customer_sub\":\"6\"}', 'Khách hàng - đối tác'),
(333, 1, 1571381532, 'booking', 'Thêm mới', '{\"booking_date\":1571763600,\"booking_customer\":\"6\",\"booking_number\":\"\",\"booking_type\":\"3\",\"booking_shipping\":\"\",\"booking_shipping_name\":\"\",\"booking_shipping_number\":\"\",\"booking_comment\":\"\\u0110\\u00f3ng cont\",\"booking_create_user\":\"1\"}', 'Đơn hàng'),
(334, 1, 1571381655, 'customer', 'Thêm mới', '{\"customer_code\":\"TN\",\"customer_name\":\"Thanh Nh\\u00e3\",\"customer_company\":\"Thanh Nh\\u00e3\",\"customer_mst\":\"\",\"customer_address\":\"\",\"customer_province\":\"1\",\"customer_phone\":\"\",\"customer_mobile\":\"\",\"customer_email\":\"\",\"customer_bank_account\":\"\",\"customer_bank_name\":\"\",\"customer_bank_branch\":\"\",\"customer_type\":\"1\",\"customer_sub\":\"6\"}', 'Khách hàng - đối tác'),
(335, 1, 1571381685, 'booking', 'Thêm mới', '{\"booking_date\":1571590800,\"booking_customer\":\"7\",\"booking_number\":\"\",\"booking_type\":\"3\",\"booking_shipping\":\"\",\"booking_shipping_name\":\"\",\"booking_shipping_number\":\"\",\"booking_comment\":\"NM NT\",\"booking_create_user\":\"1\"}', 'Đơn hàng'),
(336, 1, 1571381751, 'customer', 'Thêm mới', '{\"customer_code\":\"TGH\",\"customer_name\":\"Th\\u00e1i Gia H\\u01b0ng\",\"customer_company\":\"Linfox\",\"customer_mst\":\"\",\"customer_address\":\"\",\"customer_province\":\"1\",\"customer_phone\":\"\",\"customer_mobile\":\"\",\"customer_email\":\"\",\"customer_bank_account\":\"\",\"customer_bank_name\":\"\",\"customer_bank_branch\":\"\",\"customer_type\":\"1\",\"customer_sub\":\"7\"}', 'Khách hàng - đối tác'),
(337, 1, 1571381999, 'booking', 'Thêm mới', '{\"booking_date\":1571331600,\"booking_customer\":\"8\",\"booking_number\":\"\",\"booking_type\":\"3\",\"booking_shipping\":\"\",\"booking_shipping_name\":\"\",\"booking_shipping_number\":\"\",\"booking_comment\":\"8.21T\",\"booking_create_user\":\"1\"}', 'Đơn hàng'),
(338, 1, 1624434423, 'booking', 'Thêm m?i', '{\"booking_date\":1624381200,\"booking_customer\":\"6\",\"booking_number\":\"BK06202103\",\"booking_type\":\"2\",\"booking_shipping\":\"1\",\"booking_shipping_name\":\"NP2\",\"booking_shipping_number\":\"001\",\"booking_comment\":\"BK06\",\"booking_create_user\":\"1\"}', '??n hàng'),
(339, 1, 1624434564, 'booking', 'C?p nh?t', '{\"booking_date\":1624467600,\"booking_customer\":\"6\",\"booking_number\":\"BK06202103\",\"booking_type\":\"2\",\"booking_shipping\":\"1\",\"booking_shipping_name\":\"NP2\",\"booking_shipping_number\":\"001\",\"booking_comment\":\"BK06\",\"booking_update_user\":\"1\"}', '??n hàng'),
(340, 1, 1624436305, 'shipment_temp', 'Nh?n', '{\"shipment_temp_date\":1624381200,\"shipment_temp_owner\":\"1\",\"shipment_temp_booking\":\"13\",\"shipment_temp_status\":0,\"shipment_temp_ton\":\"0\",\"shipment_temp_number\":\"10\"}', 'Lô hàng m?i'),
(341, 1, 1624436382, 'coordinate', 'Thêm m?i', '{\"coordinate_date\":1624381200,\"coordinate_code\":\"DX02\",\"coordinate_vehicle\":\"5\",\"coordinate_booking\":\"13\",\"coordinate_booking_number\":\"BK06202103\",\"coordinate_place\":\"4\",\"coordinate_unit\":\"6\",\"coordinate_number\":\"10\",\"coordinate_type\":\"2\",\"coordinate_comment\":\"H\\u00e0ng n\\u1eb7ng\",\"coordinate_create_user\":\"1\"}', 'L?nh ?i?u xe'),
(342, 1, 1624436382, 'coordinate', 'Thêm m?i', '{\"coordinate_date\":1624381200,\"coordinate_code\":\"DX02\",\"coordinate_vehicle\":\"6\",\"coordinate_booking\":\"3\",\"coordinate_booking_number\":\"BK352724\",\"coordinate_place\":\"2\",\"coordinate_unit\":\"2\",\"coordinate_number\":\"30\",\"coordinate_type\":\"1\",\"coordinate_comment\":\"B\\u1ed9t m\\u00ec\",\"coordinate_create_user\":\"1\"}', 'L?nh ?i?u xe'),
(343, 1, 1624436517, 'coordinate', 'Cập nhật', '{\"coordinate_date\":1624381200,\"coordinate_code\":\"DX02\",\"coordinate_vehicle\":\"5\",\"coordinate_booking\":\"\\\"13\\\"\",\"coordinate_booking_number\":\"BK06202103\",\"coordinate_place\":\"4\",\"coordinate_unit\":\"6\",\"coordinate_number\":\"10\",\"coordinate_type\":\"2\",\"coordinate_comment\":\"H\\u00e0ng n\\u1eb7ng\",\"coordinate_update_user\":\"1\"}', 'Lệnh điều xe'),
(344, 1, 1624436523, 'coordinate', 'Cập nhật', '{\"coordinate_date\":1624381200,\"coordinate_code\":\"DX02\",\"coordinate_vehicle\":\"6\",\"coordinate_booking\":\"\\\"3\\\"\",\"coordinate_booking_number\":\"BK352724\",\"coordinate_place\":\"2\",\"coordinate_unit\":\"2\",\"coordinate_number\":\"30\",\"coordinate_type\":\"1\",\"coordinate_comment\":\"B\\u1ed9t m\\u00ec\",\"coordinate_update_user\":\"1\"}', 'Lệnh điều xe'),
(345, 1, 1624438256, 'dispatch', 'Thêm mới', '{\"dispatch_date\":1624381200,\"dispatch_code\":\"DX06\",\"dispatch_vehicle\":\"5\",\"dispatch_romooc\":\"undefined\",\"dispatch_staff\":\"undefined\",\"dispatch_place_from\":\"1\",\"dispatch_place_to\":\"2\",\"dispatch_start_date\":1624467600,\"dispatch_end_date\":1624467600,\"dispatch_port_from\":\"\",\"dispatch_port_to\":\"\",\"dispatch_ton\":\"1\",\"dispatch_unit\":\"6\",\"dispatch_comment\":\"H\\u00e0ng xu\\u1ea5t\",\"dispatch_shipment_temp\":\"5\",\"dispatch_customer\":\"6\",\"dispatch_booking\":\"13\",\"dispatch_booking_type\":\"2\",\"dispatch_place_from_sub\":\"\",\"dispatch_place_to_sub\":\"\",\"dispatch_start_date_sub\":false,\"dispatch_end_date_sub\":false,\"dispatch_port_from_sub\":\"\",\"dispatch_port_to_sub\":\"\",\"dispatch_ton_sub\":\"\",\"dispatch_unit_sub\":\"6\",\"dispatch_comment_sub\":\"\",\"dispatch_shipment_temp_sub\":\"\",\"dispatch_customer_sub\":\"\",\"dispatch_booking_sub\":\"\",\"dispatch_booking_type_sub\":\"\",\"dispatch_create_user\":\"1\"}', 'Lệnh điều xe'),
(346, 1, 1624438773, 'shipment', 'Thêm mới', '{\"shipment_date\":1624381200,\"shipment_dispatch\":\"11\",\"shipment_customer\":\"6\",\"shipment_type\":\"2\",\"shipment_do\":\"DO002323\",\"shipment_vehicle\":\"5\",\"shipment_romooc\":\"undefined\",\"shipment_staff\":\"undefined\",\"shipment_booking\":\"13\",\"shipment_booking_detail\":\"10\",\"shipment_container\":\"BLU99323\",\"shipment_ton_receive\":\"1\",\"shipment_ton\":\"1\",\"shipment_unit\":\"6\",\"shipment_place_from\":\"1\",\"shipment_place_to\":\"2\",\"shipment_start_date\":1624467960,\"shipment_end_date\":1624467960,\"shipment_port_from\":null,\"shipment_port_to\":null,\"shipment_comment\":\"H\\u00e0ng xu\\u1ea5t\",\"shipment_price\":\"undefined\",\"shipment_sub\":\"0\",\"shipment_road\":\"1,2\",\"shipment_create_user\":\"1\",\"shipment_cost_detail\":\"{\\\"shipment_cost_lift_on\\\":\\\"0\\\",\\\"shipment_cost_lift_off\\\":\\\"0\\\",\\\"shipment_cost_lift_on_null\\\":\\\"0\\\",\\\"shipment_cost_lift_off_null\\\":\\\"0\\\",\\\"shipment_cost_deposit\\\":\\\"0\\\",\\\"shipment_cost_clean\\\":\\\"0\\\",\\\"shipment_cost_trans\\\":\\\"0\\\",\\\"shipment_cost_weight\\\":\\\"0\\\",\\\"shipment_cost_document\\\":\\\"0\\\",\\\"shipment_cost_toll\\\":\\\"60000\\\",\\\"shipment_cost_cont\\\":\\\"480000\\\",\\\"shipment_cost_ton\\\":\\\"150000\\\",\\\"shipment_cost_police\\\":\\\"300000\\\",\\\"shipment_cost_tire\\\":\\\"350000\\\",\\\"shipment_cost_release\\\":\\\"0\\\",\\\"shipment_cost_park\\\":\\\"0\\\"}\"}', 'Phiếu vận chuyển'),
(347, 1, 1635231379, 'shipping', 'Thêm mới', '{\"shipping_country\":\"220\",\"shipping_name\":\"VIETSUN\"}', 'Hãng tàu'),
(348, 1, 1635231407, 'booking', 'Thêm mới', '{\"booking_date\":1635181200,\"booking_customer\":\"8\",\"booking_number\":\"VH25-2HPG1125S\",\"booking_type\":\"1\",\"booking_shipping\":\"6\",\"booking_shipping_name\":\"VIETSUN HARMONY 1125S\",\"booking_shipping_number\":\"CAIIU6869966\",\"booking_comment\":\"\",\"booking_create_user\":\"1\"}', 'Đơn hàng'),
(349, 1, 1635231412, 'booking', 'Thêm mới', '{\"booking_date\":1635181200,\"booking_customer\":\"8\",\"booking_number\":\"VH25-2HPG1125S\",\"booking_type\":\"1\",\"booking_shipping\":\"6\",\"booking_shipping_name\":\"VIETSUN HARMONY 1125S\",\"booking_shipping_number\":\"CAIIU6869966\",\"booking_comment\":\"\",\"booking_create_user\":\"1\"}', 'Đơn hàng'),
(350, 1, 1635231421, 'booking', 'Xóa', '\"15\"', 'Đơn hàng'),
(351, 1, 1635231535, 'shipment_temp', 'Nhận', '{\"shipment_temp_date\":1635267600,\"shipment_temp_owner\":\"1\",\"shipment_temp_booking\":\"14\",\"shipment_temp_status\":0,\"shipment_temp_ton\":\"0\",\"shipment_temp_number\":\"1\"}', 'Lô hàng mới'),
(352, 1, 1635250217, 'customer', 'Thêm mới', '{\"customer_code\":\"VTTC\",\"customer_name\":\"NGUY\\u1ec4N QUANG TUY\\u00caN\",\"customer_company\":\"C\\u00d4NG TY C\\u1ed4 PH\\u1ea6N DU L\\u1ecaCH V\\u00c0 TH\\u01af\\u01a0NG M\\u1ea0I - VINACOMIN\",\"customer_mst\":\"0 1 0 0 1 0 1 2 9 8\",\"customer_address\":\"T\\u1ea7ng 8, T\\u00f2a nh\\u00e0 Vi\\u1ec7t \\u00c1, ph\\u1ed1 Duy T\\u00e2n, Ph\\u01b0\\u1eddng D\\u1ecbch V\\u1ecdng H\\u1eadu, Qu\\u1eadn C\\u1ea7u Gi\\u1ea5y, Th\\u00e0nh ph\\u1ed1 H\\u00e0 N\\u1ed9i, Vi\\u1ec7t Nam\",\"customer_province\":\"24\",\"customer_phone\":\"\",\"customer_mobile\":\"\",\"customer_email\":\"\",\"customer_bank_account\":\"0011000381367\",\"customer_bank_name\":\"Vietcombank\",\"customer_bank_branch\":\"S\\u1edf Giao D\\u1ecbch\",\"customer_type\":\"1\",\"customer_sub\":\"8\"}', 'Khách hàng - đối tác'),
(353, 1, 1635250258, 'customer', 'Cập nhật', '{\"customer_code\":\"VTTC\",\"customer_name\":\"VTTC\",\"customer_company\":\"C\\u00d4NG TY C\\u1ed4 PH\\u1ea6N DU L\\u1ecaCH V\\u00c0 TH\\u01af\\u01a0NG M\\u1ea0I - VINACOMIN\",\"customer_mst\":\"0 1 0 0 1 0 1 2 9 8\",\"customer_address\":\"T\\u1ea7ng 8, T\\u00f2a nh\\u00e0 Vi\\u1ec7t \\u00c1, ph\\u1ed1 Duy T\\u00e2n, Ph\\u01b0\\u1eddng D\\u1ecbch V\\u1ecdng H\\u1eadu, Qu\\u1eadn C\\u1ea7u Gi\\u1ea5y, Th\\u00e0nh ph\\u1ed1 H\\u00e0 N\\u1ed9i, Vi\\u1ec7t Nam\",\"customer_province\":\"24\",\"customer_phone\":\"\",\"customer_mobile\":\"\",\"customer_email\":\"\",\"customer_bank_account\":\"2147483647\",\"customer_bank_name\":\"Vietcombank\",\"customer_bank_branch\":\"S\\u1edf Giao D\\u1ecbch\",\"customer_type\":\"1\",\"customer_sub\":\"8\"}', 'Khách hàng - đối tác'),
(354, 1, 1635250301, 'booking', 'Thêm mới', '{\"booking_date\":1635181200,\"booking_customer\":\"9\",\"booking_number\":\"TH16-3HPG2131S\",\"booking_type\":\"1\",\"booking_shipping\":\"6\",\"booking_shipping_name\":\"TRUONGHAI STAR 3 - 2131S\",\"booking_shipping_number\":\"DRYU3093890\",\"booking_comment\":\"\",\"booking_create_user\":\"1\"}', 'Đơn hàng'),
(355, 1, 1635250321, 'shipment_temp', 'Nhận', '{\"shipment_temp_date\":1635267600,\"shipment_temp_owner\":\"1\",\"shipment_temp_booking\":\"16\",\"shipment_temp_status\":0,\"shipment_temp_ton\":\"0\",\"shipment_temp_number\":\"1\"}', 'Lô hàng mới'),
(356, 1, 1644068414, 'vehicle', 'Cập nhật', '{\"vehicle_brand\":\"17\",\"vehicle_model\":\"\",\"vehicle_year\":\"0\",\"vehicle_country\":\"220\",\"vehicle_owner\":\"1\",\"vehicle_number\":\"51D-80131\",\"vehicle_oil\":\"0\",\"vehicle_volume\":\"0\"}', 'Xe'),
(357, 1, 1644068421, 'vehicle', 'Cập nhật', '{\"vehicle_brand\":\"17\",\"vehicle_model\":\"\",\"vehicle_year\":\"0\",\"vehicle_country\":\"220\",\"vehicle_owner\":null,\"vehicle_number\":\"51D-80131\",\"vehicle_oil\":\"0\",\"vehicle_volume\":\"0\"}', 'Xe'),
(358, 1, 1646129082, 'coordinate', 'Thêm mới', '{\"coordinate_date\":1646067600,\"coordinate_code\":\"DX03\",\"coordinate_vehicle\":\"5\",\"coordinate_booking\":\"\",\"coordinate_booking_number\":\"sdsa\",\"coordinate_place\":\"4\",\"coordinate_unit\":\"6\",\"coordinate_number\":\"4\",\"coordinate_type\":\"1\",\"coordinate_comment\":\"44\",\"coordinate_create_user\":\"1\"}', 'Lệnh điều xe'),
(359, 1, 1646130446, 'shipment_temp', 'Nhận', '{\"shipment_temp_date\":false,\"shipment_temp_owner\":\"1\",\"shipment_temp_booking\":\"10\",\"shipment_temp_status\":0,\"shipment_temp_ton\":\"0\",\"shipment_temp_number\":\"\"}', 'Lô hàng mới'),
(360, 1, 1646226670, 'coordinate', 'Thêm mới', '{\"coordinate_date\":1646154000,\"coordinate_code\":\"DX04\",\"coordinate_vehicle\":\"5\",\"coordinate_booking\":\"\",\"coordinate_booking_number\":\"bhb\",\"coordinate_place\":\"4\",\"coordinate_unit\":\"6\",\"coordinate_number\":\"4\",\"coordinate_type\":\"1\",\"coordinate_comment\":\"hg\",\"coordinate_create_user\":\"1\"}', 'Lệnh điều xe'),
(361, 1, 1646226672, 'coordinate', 'Thêm mới', '{\"coordinate_date\":1646154000,\"coordinate_code\":\"DX04\",\"coordinate_vehicle\":\"5\",\"coordinate_booking\":\"\",\"coordinate_booking_number\":\"bhb\",\"coordinate_place\":\"4\",\"coordinate_unit\":\"6\",\"coordinate_number\":\"4\",\"coordinate_type\":\"1\",\"coordinate_comment\":\"hg\",\"coordinate_create_user\":\"1\"}', 'Lệnh điều xe'),
(362, 1, 1646226840, 'booking', 'Thêm mới', '{\"booking_date\":1646154000,\"booking_customer\":\"6\",\"booking_number\":\"1234\",\"booking_type\":\"2\",\"booking_shipping\":\"\",\"booking_shipping_name\":\"bnm\",\"booking_shipping_number\":\"nb\",\"booking_comment\":\"nk\",\"booking_create_user\":\"1\"}', 'Đơn hàng');
...
(3, '51D-27360', '17', 'FL8JTSL6X', 0, 220, 0, 0, 7684),
(4, '51D-14199', '17', '', 0, 220, 0, 0, 0),
(5, '51C-86365', '17', '', 0, 220, 0, 0, 0),
(6, '51C-87101', '17', '', 0, 220, 0, 0, 0),
(7, '51D-47050', '17', '', 0, 220, 0, 0, 0),
(8, '51D-80131', '17', '', 0, 220, NULL, 0, 0),
(9, '68C-04433', '17', '', 0, 220, 1, 0, 0),
(10, '68C-03744', '17', '', 0, 220, 1, 0, 0);
