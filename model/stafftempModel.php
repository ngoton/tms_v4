...
Class stafftempModel Extends baseModel {
	protected $table = "staff_temp";
    ...
    public function deleteStaff($id){
    	if ($this->getStaff($id)) {
    		return $this->delete($this->table,array('staff_temp_id'=>$id));
    	}
    }
    ...
    public function getAllStaffByWhere($id){
        return $this->query('SELECT * FROM staff_temp WHERE staff_temp_id != '.$id);
    }
