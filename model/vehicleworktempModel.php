...
Class vehicleworktempModel Extends baseModel {
	protected $table = "vehicle_work_temp";
    ...
    public function deleteVehicle($id){
    	if ($this->getVehicle($id)) {
    		return $this->delete($this->table,array('vehicle_work_temp_id'=>$id));
    	}
    }
    ...
    public function getAllVehicleByWhere($id){
        return $this->query('SELECT * FROM vehicle_work_temp WHERE vehicle_work_temp_id != '.$id);
    }
