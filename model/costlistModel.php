...
Class costlistModel Extends baseModel {
	protected $table = "cost_list";
    ...
    public function deleteCost($id){
    	if ($this->getCost($id)) {
    		return $this->delete($this->table,array('cost_list_id'=>$id));
    	}
    }
    ...
    public function getAllCostByWhere($id){
        return $this->query('SELECT * FROM cost_list WHERE cost_list_id != '.$id);
    }
