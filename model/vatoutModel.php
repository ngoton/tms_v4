...
Class vatoutModel Extends baseModel {
	protected $table = "vat_out";
    ...
    public function deleteVAT($id){
    	if ($this->getVAT($id)) {
    		return $this->delete($this->table,array('vat_out_id'=>$id));
    	}
    }
    ...
    public function getAllVATByWhere($id){
        return $this->query('SELECT * FROM vat_out WHERE vat_out_id != '.$id);
    }
