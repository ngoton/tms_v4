...
Class routetempModel Extends baseModel {
	protected $table = "route_temp";
    ...
    public function deletePlace($id){
    	if ($this->getPlace($id)) {
    		return $this->delete($this->table,array('route_temp_id'=>$id));
    	}
    }
    ...
    public function getAllPlaceByWhere($id){
        return $this->query('SELECT * FROM route_temp WHERE route_temp_id != '.$id);
    }
