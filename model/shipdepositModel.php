...
Class shipdepositModel Extends baseModel {
	protected $table = "shipdeposit";
    ...
    public function deleteShipping($id){
    	if ($this->getShipping($id)) {
    		return $this->delete($this->table,array('shipdeposit_id'=>$id));
    	}
    }
    ...
    public function getAllShippingByWhere($id){
        return $this->query('SELECT * FROM shipdeposit WHERE shipdeposit_id != '.$id);
    }
