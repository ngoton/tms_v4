...
Class importstockModel Extends baseModel {
	protected $table = "import_stock";
    ...
    public function deleteStock($id){
    	if ($this->getStock($id)) {
    		return $this->delete($this->table,array('import_stock_id'=>$id));
    	}
    }
    ...
    public function getAllStockByWhere($id){
        return $this->query('SELECT * FROM import_stock WHERE import_stock_id != '.$id);
    }
