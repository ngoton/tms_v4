...
Class loanunitModel Extends baseModel {
	protected $table = "loan_unit";
    ...
    public function deleteUnit($id){
    	if ($this->getUnit($id)) {
    		return $this->delete($this->table,array('loan_unit_id'=>$id));
    	}
    }
    ...
    public function getAllUnitByWhere($id){
        return $this->query('SELECT * FROM loan_unit WHERE loan_unit_id != '.$id);
    }
