...
Class romooctempModel Extends baseModel {
	protected $table = "romooc_temp";
    ...
    public function deleteVehicle($id){
    	if ($this->getVehicle($id)) {
    		return $this->delete($this->table,array('romooc_temp_id'=>$id));
    	}
    }
    ...
    public function getAllVehicleByWhere($id){
        return $this->query('SELECT * FROM romooc_temp WHERE romooc_temp_id != '.$id);
    }
    public function getLastVehicle(){
        return $this->getLast($this->table);
    }
    public function checkVehicle($id,$vehicle_number){
        return $this->query('SELECT * FROM romooc_temp WHERE romooc_id != '.$id.' AND romooc_number = "'.$vehicle_number.'"');
    }
