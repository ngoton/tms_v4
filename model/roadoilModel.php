...
Class roadoilModel Extends baseModel {
	protected $table = "road_oil";
    ...
    public function deleteRoad($id){
    	if ($this->getRoad($id)) {
    		return $this->delete($this->table,array('road_oil_id'=>$id));
    	}
    }
    ...
    public function getAllRoadByWhere($id){
        return $this->query('SELECT * FROM road_oil WHERE road_oil_id != '.$id);
    }
