...
Class placetempModel Extends baseModel {
	protected $table = "place_temp";
    ...
    public function deletePlace($id){
    	if ($this->getPlace($id)) {
    		return $this->delete($this->table,array('place_temp_id'=>$id));
    	}
    }
    ...
    public function getAllPlaceByWhere($id){
        return $this->query('SELECT * FROM place_temp WHERE place_temp_id != '.$id);
    }
