...
Class bankbalanceModel Extends baseModel {
    ...
    public function deleteBank($id){
    	if ($this->getBank($id)) {
    		return $this->delete($this->table,array('bank_balance_id'=>$id));
    	}
    }
    ...
    public function getAllBankByWhere($id){
        return $this->query('SELECT * FROM bank_balance WHERE bank_balance_id != '.$id);
    }
