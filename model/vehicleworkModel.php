...
Class vehicleworkModel Extends baseModel {
	protected $table = "vehicle_work";
    ...
    public function deleteVehicle($id){
    	if ($this->getVehicle($id)) {
    		return $this->delete($this->table,array('vehicle_work_id'=>$id));
    	}
    }
    ...
    public function getAllVehicleByWhere($id){
        return $this->query('SELECT * FROM vehicle_work WHERE vehicle_work_id != '.$id);
    }
