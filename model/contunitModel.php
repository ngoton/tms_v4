...
Class contunitModel Extends baseModel {
	protected $table = "cont_unit";
    ...
    public function deleteUnit($id){
    	if ($this->getUnit($id)) {
    		return $this->delete($this->table,array('cont_unit_id'=>$id));
    	}
    }
    ...
    public function getAllUnitByWhere($id){
        return $this->query('SELECT * FROM cont_unit WHERE cont_unit_id != '.$id);
    }
