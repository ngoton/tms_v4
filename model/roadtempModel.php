...
Class roadtempModel Extends baseModel {
	protected $table = "road_temp";
    ...
    public function deleteRoad($id){
    	if ($this->getRoad($id)) {
    		return $this->delete($this->table,array('road_temp_id'=>$id));
    	}
    }
    ...
    public function getAllRoadByWhere($id){
        return $this->query('SELECT * FROM road_temp WHERE road_temp_id != '.$id);
    }
